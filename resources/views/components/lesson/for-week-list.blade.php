<x-card.list.table-layout :title="$title">
    <x-slot name="header">
        <x-card.list.table-header class="col-span-3" name="data"/>
        <x-card.list.table-header class="col-span-3" name="turma"/>
        <x-card.list.table-header class="col-span-3" name="disciplina"/>
